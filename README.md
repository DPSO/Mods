...
<p align="center">
    <a href="https://github.com/DPSO/Mods/issues">
        <img src="https://img.shields.io/github/issues-raw/DPSO/Mods.svg?label=Issues" alt="DPSO Mods Issues">
    </a>
    <a href="https://github.com/DPSO/Mods/blob/master/LICENSE">
        <img src="https://img.shields.io/badge/License-GPLv2-red.svg" alt="DPSO Mods License">
    </a>
    <a href="https://github.com/DPSO/Mods/actions">
        <img src="https://github.com/DPSO/Mods/workflows/Arma/badge.svg">
    </a>
</p>
...
**DPSO Mods** is a collaborative effort by the members of <a href="https//armaforces.com/">DPSO</a>, polish Arma 3 community.

Main purpose of this addon is to bend and adjust Arma 3 game features to the Group gameplay needs and style.

The mod is on the same foundation as the ACE3 mod, using its framework, systems, tools and standards. It is entirely **open-source** and licensed under the GNU General Public License ([GPLv2](https://github.com/DPSO/Mods/blob/master/LICENSE)).
